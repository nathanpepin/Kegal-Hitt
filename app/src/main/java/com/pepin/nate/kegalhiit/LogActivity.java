...
import com.pepin.nate.kegalhiit.DB.DB_LogAdapter;
import com.pepin.nate.kegalhiit.DB.DB_Workout;
...
public class LogActivity extends AppCompatActivity {
    ...
    private void initData(){
        ...
        for(DB_Workout db_workout : results){
            String builder = "Squeeze: " + FormatTime.convertSeconds(db_workout.getFocus());
            mFocus.add(builder);
        }
