...
import com.pepin.nate.kegalhiit.Data.Constants;
import com.pepin.nate.kegalhiit.Data.DataHelper;
import com.pepin.nate.kegalhiit.Data.FormatTime;
import com.pepin.nate.kegalhiit.MainActivity;
...
public class Focus_max extends AppCompatActivity {
    ...
    private TextView tv_testMaxStatusText;
    ...
    private void init_Views() {
        ...
        String t_cFocusMax = "Squeeze Max: " + FormatTime.convertSeconds(dataHelper.focusMax);
        tv_cFocusMax.setText(t_cFocusMax);

        tv_testMaxStatusText = findViewById(R.id.test_max_squeezeTime);
    ...
    /////////////////////////////////////////////////////*/
    public void confirm(int timeCount) {
        ...
        if (timeCount >= 0) {
            ...
            if (timeCount > dataHelper.focusMax) {
                //Ensures that the new focusMax will be set
                dataHelper.XP = 100;
                dataHelper.nextFocusMax = timeCount;
            ...
            throw new IllegalArgumentException("Unexpected time value");
        }
    ...
    private BroadcastReceiver mMessageReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            String currentTime = FormatTime.convertSeconds(mService.timeCount);
            tv_testMaxStatusText.setText(currentTime);
